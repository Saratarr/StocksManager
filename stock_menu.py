...
def add_stock(stock_list):
    ...
    while option != "0":
        ...
        option = input("Press Enter to add another stock or 0 to return to main menu: ")
...
def delete_stock(stock_list):
    ...
    print("]")
    symbol = input("Enter the symbol of the stock to delete: ").upper()
    found = False
    i = 0
    for stock in stock_list:
    ...
    print()
    _ = input("Stock deleted. Press Enter to return to main menu.")
...
def display_stock_chart(stock_list,symbol):
    print("Your data will be displayed in a chart: ")
    date = []
    price = []
    volume = []
    company = ""
...
def import_stock_csv(stock_list):
    print("Add historical data to a stock in the stock list")
    print("Stock List: [",end="")
    for stock in stock_list:
        print(stock.symbol," ",end="")
    print("]")
